...
class VQVAETrainer(keras.models.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            # 計算 MSE 損失
            mse_loss = tf.reduce_mean(tf.keras.losses.mse(x, reconstructions))
        ...
        return {
            ...
            'acc': self.similarity_tracker.result()  # 返回相似度作為準確率
        }
...
plt.plot(history.history['mse_loss'], label='MSE Loss')
